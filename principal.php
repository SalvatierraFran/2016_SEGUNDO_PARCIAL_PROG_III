...
$unUsuario = json_decode($_SESSION["Usuario"]);
if(isset($_COOKIE["CookieColor" . $unUsuario->id])){
    $CookieColor = "background-color:" . $_COOKIE["CookieColor" . $unUsuario->id];
}
?>
<html>
    <head>
    ...
    <body id="miBody" style="<?php echo $CookieColor; ?>">
        <div class="container" style="width:100%" >
            <div class="page-header">
				...
				echo "<a class='btn btn-primary animated bounceInLeft' href='#' onclick='EditarUsuario()'" . $_SESSION["Usuario"] . ")' " . (($unUsuario->perfil == "invitado")? "style ='display:none'" : "") . "><span class='glyphicon glyphicon-user'></span>Editar Perfil&nbsp;</a>";
				echo "<a class='btn btn-info animated bounceInLeft' href='#' onclick='CargarFormUsuario(4)'" . (($unUsuario->perfil!="administrador")? "style='display:none'" : "") . "><span class='glyphicon glyphicon-user'>&nbsp;</span><span class='glyphicon glyphicon-plus-sign'></span>Agregar Usuario&nbsp;</a>";
                ...
                <span id="spanDatos" class="animated bounceInRight" style='margin-top:-10px' ><h3><?php /*IMPLEMENTAR...*/ echo $unUsuario->nombre . " - " . $unUsuario->perfil; ?>&nbsp;&nbsp;</h3></span>
            </div>
